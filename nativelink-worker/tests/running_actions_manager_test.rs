...
> {
    ...
    let cas_store = Pin::new(Arc::new(FastSlowStore::new(
        &nativelink_config::stores::FastSlowStore {
            fast: nativelink_config::stores::StoreConfig {
                name: "fast".to_owned(),
                config: nativelink_config::stores::StoreConfigOptions::filesystem(fast_config),
            },
            slow: nativelink_config::stores::StoreConfig {
                name: "fast".to_owned(),
                config: nativelink_config::stores::StoreConfigOptions::memory(slow_config),
            },
        },
