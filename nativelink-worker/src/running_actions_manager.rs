...
pub struct RunningActionsManagerArgs<'a> {
    ...
    pub max_cleanup_wait_s: Duration,
    pub max_cleanup_backoff_ms: Duration,
...
pub struct RunningActionsManagerImpl {
    ...
    max_cleanup_wait_s: Duration,
    max_cleanup_backoff_ms: Duration,
...
impl RunningActionsManagerImpl {
    pub fn new_with_callbacks(
        ...
        Ok(Self {
            ...
            max_cleanup_wait_s: args.max_cleanup_wait_s,
            max_cleanup_backoff_ms: args.max_cleanup_backoff_ms,
    ...
    async fn wait_for_cleanup_if_needed(&self, operation_id: &OperationId) -> Result<(), Error> {
        ...
        loop {
            ...
            if start.elapsed() > self.max_cleanup_wait_s {
            ...
            tokio::select! {
                ...
                () = tokio::time::sleep(backoff) => {
                    // Exponential backoff
                    backoff = (backoff * 2).min(self.max_cleanup_backoff_ms);
                },
            }
        }
    }
