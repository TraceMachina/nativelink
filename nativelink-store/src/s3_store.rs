...
pub struct S3Store<I: InstantWrapper, NowFn: Fn() -> I + Send + Sync + Unpin + 'static> {
...
#[async_trait]
impl<I, NowFn> StoreDriver for S3Store<I, NowFn>
where
    I: InstantWrapper,
    NowFn: Fn() -> I + Send + Sync + Unpin + 'static,
{
...
#[async_trait]
impl<I, NowFn> HealthStatusIndicator for S3Store<I, NowFn>
where
    I: InstantWrapper,
    NowFn: Fn() -> I + Send + Sync + Unpin + 'static,
{
