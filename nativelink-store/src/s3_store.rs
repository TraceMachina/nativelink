...
use nativelink_config::stores::ExperimentalAwsConfig;
...
{
    pub async fn new(spec: &ExperimentalAwsConfig, now_fn: NowFn) -> Result<Arc<Self>, Error> {
