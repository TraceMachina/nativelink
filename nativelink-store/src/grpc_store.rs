...
impl GrpcStore {
    ...
    pub async fn find_missing_blobs(
        ...
        self.perform_request(request, |request| async move {
            ...
            let result = ContentAddressableStorageClient::new(connection.get_channel())
    ...
    async fn read_internal(
        ...
        let connection = self.connection_manager.get_connection().await;
        let result = ByteStreamClient::new(connection.get_channel())
    ...
    pub async fn get_action_result(
        ...
        self.perform_request(request, |request| async move {
            let connection = self.connection_manager.get_connection().await;
            let result = ActionCacheClient::new(connection.get_channel())
