...
pub struct RedisStore {
    ...
    /// Whether or not the Redis server is operating in [cluster mode](https://redis.io/docs/latest/operate/oss_and_stack/reference/cluster-spec/).
    ///
    /// If set to true, the connection will be made in cluster mode and data
    /// will be distributed amongst available nodes.
    ///
    /// Default: false,
    #[serde(default)]
    pub cluster: bool,
