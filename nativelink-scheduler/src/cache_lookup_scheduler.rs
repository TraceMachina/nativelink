...
impl CacheLookupScheduler {
    pub fn new(
        _ac_store: Store,
        _action_scheduler: Arc<dyn ActionScheduler>,
    ) -> Result<Self, Error> {
        Ok(Self {
            // ac_store,
            // action_scheduler,
...
impl ActionScheduler for CacheLookupScheduler {
    ...
    async fn add_action(
        ...
        todo!("we need to keep a local client_operation_id map here and clean it up automatically, maybe with eviction_map?");
        ...
        //     {
        //         return Ok((ClientOperationId::new(action_info.unique_qualifier), rx));
        //     }
        ...
        //     }
        // });
        // Ok((ClientOperationId::new(unique_qualifier), rx))
    }
