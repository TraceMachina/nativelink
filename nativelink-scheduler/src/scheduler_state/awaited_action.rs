...
// TODO: this should't be necessary, see below comment.
#[rustfmt::skip]
impl AwaitedActionSortKey {
    const fn new(priority: i32, insert_timestamp: u64, hash: [u8; 4]) -> Self {
        ...
        // TODO: I can't find a way to make clippy not complain about this that doesn't introduce another complaint.
...
// TODO: Shouldn't these be tests? Why are we inlining asserts here.
// Also there are a ton of complaints about every part of this and it's not maintainable code.
// This needs to be adjusted heavily.
const_assert_eq!(
