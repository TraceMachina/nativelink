...
use crate::redis::subscription_manager::{RedisOperationSubscribers, RedisOperationSubscriber};
...
impl AwaitedActionDb for RedisAwaitedActionDb {
    ...
    async fn update_awaited_action(
        ...
        self.redis_adapter.update_awaited_action(new_awaited_action).await
    }
    ...
    async fn get_range_of_actions(
        ...
        match self.redis_adapter.get_range_of_actions(
            state,
            start,
            end,
            desc
