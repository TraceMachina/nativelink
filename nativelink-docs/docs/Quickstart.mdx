...
curl -LO https://github.com/bazelbuild/bazel/releases/download/7.1.1/bazel-7.1.1-linux-arm64

# Make the binary executable.
chmod +x bazel-7.1.1-linux-arm64

# Move the binary to a directory in your PATH.
mv bazel-7.1.1-linux-arm64 /usr/local/bin/bazel
...
curl -LO https://github.com/bazelbuild/bazel/releases/download/7.1.1/bazel-7.1.1-linux-x86_6

# Make the binary executable.
chmod +x bazel-7.1.1-linux-x86_64

# Move the binary to a directory in your PATH.
mv bazel-7.1.1-linux-x86_64 /usr/local/bin/bazel
