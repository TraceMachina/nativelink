...
mod memory_store_tests {
    ...
    async fn ensure_full_copy_of_bytes_is_made_test() -> Result<(), Error> {
        ...
        let initial_virtual_mem = memory_stats().expect("Failed to read memory.").physical_mem;
        ...
        let new_virtual_mem = memory_stats().expect("Failed to read memory.").physical_mem;
