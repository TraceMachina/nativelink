...
mod completeness_checking_store_tests {
    ...
    const FILE4_CONTENT: &str = "HELLOFILE4";
    ...
    async fn verify_completeness_check() -> Result<(), Error> {
        ...
        pinned_ac.update_oneshot(file1_digest, FILE1_CONTENT.into()).await?;
        pinned_ac.update_oneshot(file2_digest, FILE2_CONTENT.into()).await?;
        pinned_ac.update_oneshot(file3_digest, FILE3_CONTENT.into()).await?;
    ...
    async fn verify_completeness_check_fails_with_missing_cas_item() -> Result<(), Error> {
        ...
        pinned_ac.update_oneshot(file2_digest, FILE2_CONTENT.into()).await?;
        pinned_ac.update_oneshot(file3_digest, FILE3_CONTENT.into()).await?;
        pinned_ac.update_oneshot(file3_digest, FILE4_CONTENT.into()).await?;
        ...
        assert!(res.is_err(), "Expected has_with_results to fail with missing items");
