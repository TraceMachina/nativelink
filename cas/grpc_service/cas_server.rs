...
impl ContentAddressableStorage for CasServer {
    async fn find_missing_blobs(
        ...
        let resp = self
            ...
            .await
            .err_tip(|| "Failed on find_missing_blobs() command".to_string())
            .map_err(|e| e.into());
    ...
    async fn batch_update_blobs(
        ...
        let resp = self
            ...
            .await
            .err_tip(|| "Failed on batch_update_blobs() command".to_string())
            .map_err(|e| e.into());
        let d = now.elapsed().as_secs_f32();
        if resp.is_err() {
    ...
    async fn batch_read_blobs(
        ...
        let resp = self
            ...
            .await
            .err_tip(|| "Failed on batch_read_blobs() command".to_string())
            .map_err(|e| e.into());
        let d = now.elapsed().as_secs_f32();
        if resp.is_err() {
    ...
    async fn get_tree(&self, grpc_request: Request<GetTreeRequest>) -> Result<Response<Self::GetTreeStream>, Status> {
        ...
        let resp: Result<Response<Self::GetTreeStream>, Status> = self
            ...
            .await
            .err_tip(|| "Failed on get_tree() command".to_string())
            .map_err(|e| e.into());
        let d = now.elapsed().as_secs_f32();
        match &resp {
