...
When start working on a feature your git log looks something like this:
...
all source files. If you get errors from these checks, run the following to
format the sources:
...
Assuming you're in the nix development environment:
