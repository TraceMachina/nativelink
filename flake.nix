    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      in rec {
        ...
        packages = rec {
          ...
          lre-cc = import ./local-remote-execution/cc-toolchain.nix {inherit pkgs buildImage;};
          rbe-autogen-lre-cc = rbe-autogen lre-cc;
          nativelink-worker-lre-cc = createWorker lre-cc;
          lre-java = import ./local-remote-execution/java-toolchain.nix {inherit pkgs buildImage;};
