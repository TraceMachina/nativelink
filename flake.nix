  ...
  outputs = inputs @ {
    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {
        ...
        nativelink-aarch64-darwin = nativelinkFor pkgs.pkgsCross.aarch64-darwin;
        nativelink-aarch64-linux = nativelinkFor pkgs.pkgsCross.aarch64-multiplatform-musl;
        nativelink-x86_64-darwin = nativelinkFor pkgs.pkgsCross.x86_64-darwin;
      ...
      in rec {
        ...
        packages =
          ...
          // (
            ...
            then {
              inherit
                nativelink-aarch64-darwin
                nativelink-x86_64-darwin
                ;
            }
            else {}
          );
