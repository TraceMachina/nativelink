...
use native_link_util::common::{DigestInfo, JoinHandleDropGuard};
...
/// This is a partial mirror of native_link_config::stores::Lz4Config.
...
pub struct CompressionStore {
    ...
    config: native_link_config::stores::Lz4Config,
    bincode_options: BincodeOptions,
}

impl CompressionStore {
    pub fn new(
        compression_config: native_link_config::stores::CompressionStore,
        inner_store: Arc<dyn Store>,
    ) -> Result<Self, Error> {
