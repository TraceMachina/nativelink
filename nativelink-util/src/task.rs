...
macro_rules! spawn {
    ($fut:expr, $name:expr) => {{
        $crate::task::JoinHandleDropGuard::new($crate::background_spawn!($fut, $name))
    }};
    ($fut:expr, $name:expr, $($fields:tt)*) => {{
        $crate::task::JoinHandleDropGuard::new($crate::background_spawn!($fut, $name, $($fields)*))
    }};
    ($fut:expr, target: $target:expr, $name:expr, $($fields:tt)*) => {{
        $crate::task::JoinHandleDropGuard::new($crate::background_spawn!($fut, target: $target, $name, $($fields)*))
    }};
}
...
macro_rules! spawn_blocking {
    ...
    ($fut:expr, $name:expr, $($fields:tt)*) => {{
        $crate::task::JoinHandleDropGuard::new($crate::task::__spawn_blocking($fut, $crate::task::__error_span!($name, $target, $($fields)*)))
    }};
