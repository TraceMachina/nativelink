...
/// Holds an id that is unique to the client and operation.
/// Each client should be issued a unique id even if they are
/// attached to the same underlying operation.
