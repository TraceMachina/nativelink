...
async fn parse_empty_failure() -> Result<(), Error> {
    ...
    let operation_id =
        OperationId::try_from("main/SHA256/badhash-211/0:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52")
            .err()
            .unwrap();
    assert_eq!(operation_id.messages.len(), 4);
    assert_eq!(operation_id.code, Code::InvalidArgument);
    ...
    assert_eq!(operation_id.messages[3], "Invalid ActionInfoHashKey - main/SHA256/badhash-211/0:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52");
    ...
    assert_eq!(operation_id.messages[1], "Invalid ActionInfoHashKey size value fragment - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-/0");
    assert_eq!(operation_id.messages[2], "Invalid ActionInfoHashKey - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-/0:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52");
    ...
    assert_eq!(operation_id.messages[1], "Invalid ActionInfoHashKey size value fragment - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f--211/0");
    assert_eq!(operation_id.messages[2], "Invalid ActionInfoHashKey - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f--211/0:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52");
    ...
    assert_eq!(operation_id.code, Code::InvalidArgument);
    assert_eq!(operation_id.messages[0], "invalid digit found in string");
    assert_eq!(operation_id.messages[1], "Invalid ActionInfoHashKey salt hex conversion - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-211/x");
    assert_eq!(operation_id.messages[2], "Invalid ActionInfoHashKey - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-211/x:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52");
    ...
    assert_eq!(operation_id.code, Code::InvalidArgument);
    assert_eq!(operation_id.messages[0], "invalid digit found in string");
    assert_eq!(operation_id.messages[1], "Invalid ActionInfoHashKey salt hex conversion - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-211/-10");
    assert_eq!(operation_id.messages[2], "Invalid ActionInfoHashKey - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-211/-10:19b16cf8-a1ad-4948-aaac-b6f4eb7fca52");
    ...
    assert_eq!(operation_id.messages.len(), 1);
    assert_eq!(operation_id.code, Code::Internal);
    assert_eq!(operation_id.messages[0], "Invalid OperationId unique_qualifier / id fragment - main/SHA256/4a0885a39d5ba8da3123c02ff56b73196a8b23fd3c835e1446e74a3a3ff4313f-211/0");
