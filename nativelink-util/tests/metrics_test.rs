...
use nativelink_util::metrics::{
    ...
    peak_memory_sample, pool_available_sample, record_cache_entries_added,
    record_cache_entries_removed, record_completed_execution_metrics, record_connection_acquired,
    ...
    record_worker_keepalive, record_worker_state, split_grpc_path,
};
...
fn test_cache_size_helpers_are_callable() {
    ...
    record_cache_entries_added(4096, 1, &attrs);
    record_cache_entries_removed(4096, 1, &attrs);
    record_cache_entries_added(0, 0, &attrs);
    record_cache_entries_added(u64::MAX, u64::MAX, &attrs);
    record_cache_entries_removed(u64::MAX, u64::MAX, &attrs);
}
