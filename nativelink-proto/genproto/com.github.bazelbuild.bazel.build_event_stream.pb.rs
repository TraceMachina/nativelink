...
pub mod build_metrics {
    ...
    pub struct PackageMetrics {
        ...
        pub package_load_metrics: ::prost::alloc::vec::Vec<
            super::super::super::super::super::super::devtools::build::lib::packages::metrics::PackageLoadMetrics,
        >,
    }
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
        ...
        impl WorkerStatus {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    WorkerStatus::KilledDueToMemoryPressure => {
                        "KILLED_DUE_TO_MEMORY_PRESSURE"
                    }
                    WorkerStatus::KilledUnknown => "KILLED_UNKNOWN",
                    WorkerStatus::KilledDueToInterruptedException => {
                        "KILLED_DUE_TO_INTERRUPTED_EXCEPTION"
                    }
                    WorkerStatus::KilledDueToIoException => "KILLED_DUE_TO_IO_EXCEPTION",
                    WorkerStatus::KilledDueToUserExecException => {
...
impl TestStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            TestStatus::NoStatus => "NO_STATUS",
            TestStatus::Passed => "PASSED",
            TestStatus::Flaky => "FLAKY",
            TestStatus::Timeout => "TIMEOUT",
            TestStatus::Failed => "FAILED",
            TestStatus::Incomplete => "INCOMPLETE",
            TestStatus::RemoteFailure => "REMOTE_FAILURE",
            TestStatus::FailedToBuild => "FAILED_TO_BUILD",
            TestStatus::ToolHaltedBeforeTesting => "TOOL_HALTED_BEFORE_TESTING",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
