...
impl OptionEffectTag {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            OptionEffectTag::Unknown => "UNKNOWN",
            OptionEffectTag::NoOp => "NO_OP",
            OptionEffectTag::LosesIncrementalState => "LOSES_INCREMENTAL_STATE",
            OptionEffectTag::ChangesInputs => "CHANGES_INPUTS",
            OptionEffectTag::AffectsOutputs => "AFFECTS_OUTPUTS",
            OptionEffectTag::BuildFileSemantics => "BUILD_FILE_SEMANTICS",
            OptionEffectTag::BazelInternalConfiguration => "BAZEL_INTERNAL_CONFIGURATION",
            OptionEffectTag::LoadingAndAnalysis => "LOADING_AND_ANALYSIS",
            OptionEffectTag::Execution => "EXECUTION",
            OptionEffectTag::HostMachineResourceOptimizations => {
                "HOST_MACHINE_RESOURCE_OPTIMIZATIONS"
            }
            OptionEffectTag::EagernessToExit => "EAGERNESS_TO_EXIT",
            OptionEffectTag::BazelMonitoring => "BAZEL_MONITORING",
            OptionEffectTag::TerminalOutput => "TERMINAL_OUTPUT",
            OptionEffectTag::ActionCommandLines => "ACTION_COMMAND_LINES",
            OptionEffectTag::TestRunner => "TEST_RUNNER",
        }
    }
...
impl OptionMetadataTag {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            OptionMetadataTag::Experimental => "EXPERIMENTAL",
            OptionMetadataTag::IncompatibleChange => "INCOMPATIBLE_CHANGE",
            OptionMetadataTag::Deprecated => "DEPRECATED",
            OptionMetadataTag::Hidden => "HIDDEN",
            OptionMetadataTag::Internal => "INTERNAL",
            OptionMetadataTag::Immutable => "IMMUTABLE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
