...
/// / What a worker has to spare, sent with every keepalive so the scheduler
/// / can veto a placement the admission ledger would allow. Absent from
/// / older workers.
...
pub struct KeepAliveRequest {
    /// / The worker's spare capacity as of this keepalive.
    #[prost(message, optional, tag = "1")]
    pub load: ::core::option::Option<WorkerLoad>,
}
