...
use native_link::config::cas_server::WorkerApiConfig;
use native_link::error::{Error, ResultExt};
use native_link::grpc_service::worker_api_server::{ConnectWorkerStream, NowFn, WorkerApiServer};
use native_link::scheduler::action_messages::{ActionInfo, ActionInfoHashKey, ActionStage};
use native_link::scheduler::action_scheduler::ActionScheduler;
use native_link::scheduler::platform_property_manager::PlatformProperties;
use native_link::scheduler::simple_scheduler::SimpleScheduler;
use native_link::scheduler::worker::WorkerId;
use native_link::scheduler::worker_scheduler::WorkerScheduler;
...
use proto::com::github::trace_machina::native_link::remote_execution::worker_api_server::WorkerApi;
...
async fn setup_api_server(worker_timeout: u64, now_fn: NowFn) -> Result<TestContext, Error> {
    ...
    let scheduler = Arc::new(SimpleScheduler::new(
        &native_link::config::schedulers::SimpleScheduler {
