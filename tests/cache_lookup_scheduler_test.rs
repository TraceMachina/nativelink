...
use native_link::scheduler::cache_lookup_scheduler::CacheLookupScheduler;
use native_link::scheduler::platform_property_manager::PlatformPropertyManager;
...
fn make_cache_scheduler() -> Result<TestContext, Error> {
    ...
    let cas_store = Arc::new(MemoryStore::new(&native_link::config::stores::MemoryStore::default()));
