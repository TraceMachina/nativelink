...
def generate_time_series_chart(
    results: List[Dict], project: str, test_name: str, metric: str, output_dir: str
):
        ...
        for test_name in test_names:
            ...
            for metric in metrics:
                chart_path = generate_time_series_chart(
                    results, project, test_name, metric, output_dir
                )
                if chart_path:
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate visualizations for NativeLink benchmark results"
    )
    parser.add_argument(
        "--results-dir",
    ...
    parser.add_argument(
        "--output-dir", default="./benchmark_viz", help="Directory to store visualizations"
    )
