...
data "azurerm_virtual_network" "main" {
  name                = azurerm.example.virtual_network_name
  resource_group_name = azurerm.example.resource_group_name
}

data "azurerm_subnet" "main" {
  name                 = azurerm.example.subnet_name
  virtual_network_name = azurerm.example.virtual_network_name
  resource_group_name  = azurerm.example.resource_group_name
}
