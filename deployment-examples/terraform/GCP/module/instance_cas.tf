...
resource "google_compute_region_instance_group_manager" "cas_instance_group" {
  ...
  auto_healing_policies {
    health_check      = google_compute_region_health_check.cas_health_checker.id
...
resource "google_compute_region_health_check" "cas_health_checker" {
...
resource "google_compute_region_backend_service" "cas_backend_service" {
  ...
  enable_cdn                      = "false"
  health_checks = [
    google_compute_region_health_check.cas_health_checker.id,
  ]
...
resource "google_compute_url_map" "cas_url_map" {
  ...
  default_service = google_compute_region_backend_service.cas_backend_service.id
}
