...
resource "google_compute_region_instance_group_manager" "scheduler_instance_group" {
  ...
  auto_healing_policies {
    health_check      = google_compute_region_health_check.scheduler_health_checker.id
...
resource "google_compute_region_health_check" "scheduler_health_checker" {
...
resource "google_compute_backend_service" "scheduler_backend_service" {
  ...
  enable_cdn                      = "false"
  health_checks = [
    google_compute_region_health_check.scheduler_health_checker.id,
  ]
