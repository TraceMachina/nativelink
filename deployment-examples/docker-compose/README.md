...
deployment of Native Link's cache and remote execution system.
...
The CAS (Content Addressable Storage) service is used as a local cache for the Native Link system. It's configured in the docker-compose.yml file under the nativelink_local_cas service.
...
The scheduler service is responsible for scheduling tasks in the Native Link system. It's configured in the docker-compose.yml file under the nativelink_scheduler service.
