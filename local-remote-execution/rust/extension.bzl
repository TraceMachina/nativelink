...
def _lre_rs_impl(_mctx):
    new_local_repository(
        ...
        path = "/nix/store/dbib5q6rhw2yqj5iinw7j2aqqhy37jxn-rust-default-1.85.0",
    )
    new_local_repository(
        name = "lre-rs-nightly-aarch64-darwin",
        build_file = "@local-remote-execution//rust:aarch64-darwin.BUILD.bazel",
        path = "/nix/store/yj87h79s0c9c9cisivrw2p4g9n6icnp5-rust-default-1.86.0-nightly-2025-01-15",
    )
    new_local_repository(
        name = "lre-rs-stable-aarch64-linux",
        build_file = "@local-remote-execution//rust:aarch64-linux.BUILD.bazel",
        path = "/nix/store/7vn7iiiziwcd6b8wwbrkvknkx2ipmar1-rust-default-1.85.0",
    )
    new_local_repository(
        name = "lre-rs-nightly-aarch64-linux",
        build_file = "@local-remote-execution//rust:aarch64-linux.BUILD.bazel",
        path = "/nix/store/jk003n0p2hh99l70lvkrr8rad5fx258i-rust-default-1.86.0-nightly-2025-01-15",
    )
    new_local_repository(
        name = "lre-rs-stable-x86_64-darwin",
        build_file = "@local-remote-execution//rust:x86_64-darwin.BUILD.bazel",
        path = "/nix/store/4gh0lacx6a15d29fvcjv16xwm41lx39k-rust-default-1.85.0",
    )
    new_local_repository(
        name = "lre-rs-nightly-x86_64-darwin",
        build_file = "@local-remote-execution//rust:x86_64-darwin.BUILD.bazel",
        path = "/nix/store/wvdmjb3m2s81krzf8krv229mc0s4w05i-rust-default-1.86.0-nightly-2025-01-15",
    )
    new_local_repository(
        name = "lre-rs-stable-x86_64-linux",
        build_file = "@local-remote-execution//rust:x86_64-linux.BUILD.bazel",
        path = "/nix/store/0pqrhsdq2kazrwy8qhd0zknxhidsbfjb-rust-default-1.85.0",
    )
    new_local_repository(
        name = "lre-rs-nightly-x86_64-linux",
        build_file = "@local-remote-execution//rust:x86_64-linux.BUILD.bazel",
        path = "/nix/store/mbb58x9kr5419h6s2qld085lsi2blqn5-rust-default-1.86.0-nightly-2025-01-15",
    )
