{
  ...
  lre-rs-configs-gen = writeShellScriptBin "lre-rs" ''
    ...
    platform(
        ...
        parents = ["@local-remote-execution//nix-system:aarch64-darwin"],
    )
    ...
    platform(
        ...
        parents = ["@local-remote-execution//nix-system:aarch64-linux"],
    )
    ...
    platform(
        ...
        parents = ["@local-remote-execution//nix-system:x86_64-darwin"],
    )
    ...
    platform(
        ...
        parents = ["@local-remote-execution//nix-system:x86_64-linux"],
    )
    ...
    cat > ''${SRC_ROOT}/lre-rs/aarch64-darwin.BUILD.bazel << EOF
