...
use native_link_worker::running_actions_manager::{
...
async fn setup_stores() -> Result<
    ...
    Error,
> {
    let fast_config = native_link_config::stores::FilesystemStore {
        content_path: make_temp_path("content_path"),
        temp_path: make_temp_path("temp_path"),
        eviction_policy: None,
        ..Default::default()
    };
    let slow_config = native_link_config::stores::MemoryStore::default();
    ...
    let cas_store = Pin::new(Arc::new(FastSlowStore::new(
        &native_link_config::stores::FastSlowStore {
            fast: native_link_config::stores::StoreConfig::filesystem(fast_config),
            slow: native_link_config::stores::StoreConfig::memory(slow_config),
        },
