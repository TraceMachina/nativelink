...
export function MobileNav({
  ...
  return (
    <>
      {/* Hamburger trigger with animated bars → X */}
      <button
        type="button"
        ...
        {open ? (
          ...
          >
            ...
            <motion.nav
              ...
              className="relative flex h-full flex-col overflow-y-auto bg-background"
            >
              {/* Header — logo + close stays sticky */}
              <div className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-border/60 bg-background/80 px-6 backdrop-blur-md">
                <a
                  href="/"
                  onClick={() => setOpen(false)}
