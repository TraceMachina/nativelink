...
[Deployment → Chromium](/docs/deployment/chromium) for a full example.
...
- [Configuration introduction](/docs/configuration/intro) — what's in
  that JSON5 file, and how to grow it from a single node to a fleet.
- [On-prem deployment](/docs/getting-started/on-prem) — survive a team
  rollout.
- [Architecture](/docs/explanations/architecture) — what each piece of
  the cluster actually does.
- [Local Remote Execution](/docs/explanations/lre) — hermetic builds on
