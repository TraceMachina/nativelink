...
if you're working on [LRE](/docs/explanations/lre) (which requires
Nix).
...
Anything from the [Bazel](/docs/contribute/bazel) or
[Cargo](/docs/contribute/cargo) workflow works inside `nix develop`.
...
See [Explanations → LRE](/docs/explanations/lre) for what these are
doing.
