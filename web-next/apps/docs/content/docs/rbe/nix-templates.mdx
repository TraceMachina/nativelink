...
For [Local Remote Execution](/docs/explanations/lre):
...
- [Architecture](/docs/explanations/architecture) — the data flow
  these templates exercise.
- [Configuration → Basic](/docs/configuration/basic) — the JSON5
  the templates ship.
