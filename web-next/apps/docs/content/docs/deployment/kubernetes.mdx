...
volume. The
[production config](/docs/configuration/production#cas-sharded-s3-redis)
...
- [Metrics](/docs/deployment/metrics) — wire it into your Grafana.
- [Persistent workers](/docs/deployment/persistent-workers) — pool
