...
use crate::util::metrics_utils::{Collector, CollectorState, CounterWithTime, MetricsComponent, Registry};
...
impl VerifyStore {
    pub fn new(config: &crate::config::stores::VerifyStore, inner_store: Arc<dyn StoreTrait>) -> Self {
        VerifyStore {
            inner_store,
