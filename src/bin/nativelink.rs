...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (mut metrics_enabled, max_blocking_threads) = {
        ...
        const DEFAULT_DIGEST_SIZE_HEALTH_CHECK: usize = 1024 * 1024;
        let global_cfg = if let Some(global_cfg) = &mut cfg.global {
            ...
            if global_cfg.default_digest_size_health_check == 0 {
                global_cfg.default_digest_size_health_check = DEFAULT_DIGEST_SIZE_HEALTH_CHECK;
            }
            ...
            *global_cfg
            ...
            GlobalConfig {
                ...
                default_digest_size_health_check: DEFAULT_DIGEST_SIZE_HEALTH_CHECK,
            }
        };
