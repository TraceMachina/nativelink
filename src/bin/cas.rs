                            ...
                            (async move {
                                worker_schedulers
                                    ...
                                    .set_drain_worker(
                                        ...
                                        match is_draining.as_str() {
                                            "0" => Ok(false),
                                            "1" => Ok(true),
                                            _ => Err(make_err!(Code::Internal, "{} is neither 0 nor 1", is_draining)),
                                        }?,
                                    )
                                    .await?;
                                Ok::<String, Error>(format!("Draining worker {worker_id}"))
                            })
                            .await
                            .map_err(|e| {
                                Err::<String, (axum::http::StatusCode, String)>((
