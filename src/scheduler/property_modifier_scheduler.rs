...
use crate::config::schedulers::{PropertyModification, PropertyType};
use crate::error::{Error, ResultExt};
use crate::scheduler::action_messages::{ActionInfo, ActionInfoHashKey, ActionState};
...
pub struct PropertyModifierScheduler {
    modifications: Vec<crate::config::schedulers::PropertyModification>,
...
impl PropertyModifierScheduler {
    pub fn new(
        config: &crate::config::schedulers::PropertyModifierScheduler,
        scheduler: Arc<dyn ActionScheduler>,
    ) -> Self {
        Self {
