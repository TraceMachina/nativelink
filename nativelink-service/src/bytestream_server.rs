...
use nativelink_util::digest_hasher::{
    ctx_for_digest_function, default_digest_hasher_func, DigestHasherFunc,
};
...
impl ByteStream for ByteStreamServer {
    ...
    async fn read(
        ...
        let resp = ctx_for_digest_function(digest_function)
    ...
    async fn write(
        ...
        ctx_for_digest_function(digest_function)
