...
const controls = [
  {
    icon: (
      <path
        d="M12 2 L4 6V13 C4 17 8 20 12 22 C16 20 20 17 20 13 V6 L12 2 Z M9 12 L11 14 L15 10"
        strokeLinecap="round"
  ...
  },
  {
    icon: (
      <>
        ...
        <path d="M5 21 v-2 c0-3 3-5 7-5 s7 2 7 5 v2" />
      </>
    ),
  ...
  },
  {
    icon: (
      <>
        ...
        <path
          d="M8 6V4 a2 2 0 0 1 2-2 h4 a2 2 0 0 1 2 2 v2 M10 13 h4 M10 17 h4"
          strokeLinecap="round"
        />
      </>
    ),
  ...
  },
  {
    icon: (
      <path
        d="M12 22 c-4 0-7-3-7-7 V7 L12 4 L19 7 v8 c0 4-3 7-7 7 Z M8 12 h8 M12 8 v8"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    ),
...
const policies = [
  {
    ...
    description: "Our internal standards for handling customer and corporate data.",
  },
  {
    name: "Incident Response Plan",
    description: "How we detect, escalate, and communicate during an incident.",
  },
  {
    name: "Sub-processor list",
    description: "The vendors that process customer data on our behalf.",
  },
          ...
          <Reveal>
            <div className="mx-auto max-w-[860px] text-center">
              ...
              <p className="mx-auto mt-6 max-w-[640px] text-[17px] leading-relaxed text-muted-foreground md:text-lg">
                NativeLink runs the build farms that ship safety-critical software. Every byte is
                content-addressed, every action is logged, and every control is auditable.
              </p>
          ...
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-[600px]">
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
                ...
                with your NDA — we'll send the relevant report within one business day.
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal>
          <ul className="divide-y divide-border overflow-hidden rounded-2xl border border-border bg-surface">
            {policies.map((p) => (
              <li
                key={p.name}
                className="flex items-center justify-between gap-6 px-6 py-5 transition-colors hover:bg-foreground/[0.02]"
              >
                <div>
        ...
        <Section width="narrow" className="py-24 text-center">
          <Reveal>
            ...
            <p className="mx-auto mt-5 max-w-[560px] text-base leading-relaxed text-muted-foreground md:text-lg">
              We triage every report within 24 hours, fix high-severity issues within 7 days, and
              credit researchers in our advisory.
            </p>
