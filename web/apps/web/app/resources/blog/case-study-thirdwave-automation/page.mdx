export const metadata = { title: "Thirdwave Automation and NativeLink" };

# Thirdwave Automation and NativeLink

#### _How NativeLink's open software development and validation platform helped a robotics innovator deliver safer products faster (at less cost)_
