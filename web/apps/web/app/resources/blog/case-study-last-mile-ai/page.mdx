export const metadata = { title: "Case Study: LastMile AI" };

# Case Study: LastMile AI

![LastMile AI](https://nativelink-cdn.s3.us-east-1.amazonaws.com/lastmileai-logo.webp)
