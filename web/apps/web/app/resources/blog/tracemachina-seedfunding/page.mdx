export const metadata = { title: "TraceMachina: Seed Funding" };

# TraceMachina: Seed Funding

![TraceMachina seed funding](https://nativelink-cdn.s3.us-east-1.amazonaws.com/tracemachina_seedfunding.webp)
