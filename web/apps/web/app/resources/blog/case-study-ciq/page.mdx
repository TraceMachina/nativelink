export const metadata = { title: "Case Study: CIQ" };

# Case Study: CIQ

![CIQ](https://nativelink-cdn.s3.us-east-1.amazonaws.com/nativelink_ciq.webp)
...
- ensure consistency across any environment, architectures, libraries, services, and tools
