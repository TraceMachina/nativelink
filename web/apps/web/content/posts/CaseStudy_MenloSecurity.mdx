...
image: /assets/menlo-security-build-time-comparison.jpg
    ...
    <dd>
      <a class="glance-company-card" href="https://www.menlosecurity.com/" rel="noopener noreferrer">
        <span class="glance-logo-frame">
          <img class="glance-logo" src="/assets/menlo-security-wordmark.svg" alt="" width="70" height="34" />
        </span>
...
<figure>
  <img src="/assets/menlo-security-build-time-comparison.jpg" alt="Chromium build wall-time at Menlo Security: 4.5 hours on the legacy distributed cache, 25 minutes with NativeLink remote execution" />
...
<figure>
  <img src="/assets/menlo-security-kubernetes-topology.jpg" alt="Menlo Security's hybrid NativeLink topology: a Kubernetes scheduler node talking gRPC to GCS and a local office CAS, and dispatching work to a warm base worker pool plus an on-demand ephemeral pool" />
