...
const iconPaths: Record<NonNullable<CalloutProps["type"]>, React.ReactNode> = {
  info: (
    <path d="M12 16v-4M12 8h.01M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z" />
  ),
  warn: (
...
export function Callout({ type = "info", title, children, className }: CalloutProps) {
  return (
    <div
      className={cn("my-6 flex gap-3 rounded-xl border px-5 py-4", tones[type], className)}
