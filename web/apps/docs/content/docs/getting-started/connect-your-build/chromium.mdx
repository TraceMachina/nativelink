...
<Accordions type="multiple">
  <Accordion title="Do I need to patch the Chromium tree?" id="do-i-need-to-patch-the-chromium-tree">
    No — pointing Siso at NativeLink is configuration only: GN args plus
    the Siso environment variables. The same applies to Chromium forks;
    Samsung Internet runs this pattern in production.
  </Accordion>
...
- [Persistent workers](/remote-execution/persistent-workers) for the
  hot toolchain paths.
- [Observability](/operate/observability) — Chromium builds produce a
