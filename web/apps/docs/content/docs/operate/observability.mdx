...
can use NativeLink Enterprise or an intentionally
...
<Accordions type="multiple">
  ...
  <Accordion title="Do metrics require a commercial license?" id="do-metrics-require-a-commercial-license">
    ...
    settings need NativeLink Enterprise or an intentionally
  ...
  <Accordion title="Which metric should drive worker autoscaling?" id="which-metric-should-drive-worker-autoscaling">
    ...
    [the Kubernetes HPA example](/operate/deploy-kubernetes) targets. CPU-based
