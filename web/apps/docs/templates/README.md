...
**Every page on the reading path states what it assumes.** Use
`<Prerequisites>`. A reader who lands cold from a search result should be told
what the page assumes and sent to the page that provides it if they don't have
it.
