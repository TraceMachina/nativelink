...
Below is an example of a basic NativeLink configuration, set up as an all-in-one
CAS, Scheduler, and Worker.

The idea of this configuration is that it can be run out of the box on your
