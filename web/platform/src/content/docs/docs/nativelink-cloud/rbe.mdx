...
<Tabs syncKey="platform">
  <TabItem label="AWS">
    ```bash
    --remote_default_exec_properties="container-image=docker://YOUR_AWS_ACCOUNT.dkr.ecr.YOUR_REGION.amazonaws.com/rbe-images:tag"
    --remote_exec_header=x-nativelink-rbe-registry-server=YOUR_AWS_ACCOUNT.dkr.ecr.YOUR_REGION.amazonaws.com
