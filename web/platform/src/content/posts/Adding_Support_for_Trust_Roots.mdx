...
Before this change, connecting to gRPC endpoints using TLS required manual certificate file configuration.
...
Previously, [`ClientTlsConfig`](https://nativelink.com/docs/reference/nativelink-config/#clienttlsconfig) required explicit file paths:
...
- **Manual certificate files:** Use existing manual certificate configuration
...
If you require mixed TLS approaches:
...
## What Good Open Source Looks Like

This contribution demonstrates thoughtful open source collaboration.
