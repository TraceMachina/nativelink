...
import {
  ...
  Tesla,
  ThirdWave,
} from "../../media/icons/customers.tsx";

export const Customers = component$(() => {
  ...
  const logos_row_width = isMobile.value ? "" : "w-[70vw]"; // Use default width on mobile
  const logo_width = isMobile.value ? "25vw" : "15vw";
  const logos_top_margin = isMobile.value ? "mt-32" : "mt-16";
  const logos_bottom_margin = isMobile.value ? "-mb-6" : "mb-8";

  const companies = [
    {
      img: <Neuralink width={logo_width} />,
    },
    {
