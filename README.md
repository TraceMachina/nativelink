...
```bash
curl -O \
    https://raw.githubusercontent.com/TraceMachina/nativelink/v1.1.1/nativelink-config/examples/basic_cas.json5
...
docker run \
    ...
    -p 50051:50051 \
    ghcr.io/tracemachina/nativelink:v1.1.1 \
    config
```
...
Invoke-WebRequest `
    -Uri "https://raw.githubusercontent.com/TraceMachina/nativelink/v1.1.1/nativelink-config/examples/basic_cas.json5" `
